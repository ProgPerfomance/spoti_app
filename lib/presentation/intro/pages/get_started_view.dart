      ...
      body: Stack(
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                Align(child: SvgPicture.asset(AppVectors.logoPath),alignment: Alignment.topCenter,),
                const Spacer(),
                ...
                BasicButtonWidget(callback: (){
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>const ChooseModeView()));
                }, title: 'Get started',height: null),
              ],
            ),
          ),
        ],
